...
export class CognitoFormComponent implements OnInit {
   ...
   * <script src="https://www.cognitoforms.com/f/seamless.js" data-key="01huc4Jc0EmOkLmxC9tZnA" data-form="2"></script>
   */
  loadCognitoFormScript() {
    const script = this.renderer.createElement('script');
    script.src = 'https://www.cognitoforms.com/f/seamless.js';
    script.setAttribute('data-key', '01huc4Jc0EmOkLmxC9tZnA');
